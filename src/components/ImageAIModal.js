  ...
  const processImage = () => {
    ...
    setTimeout(() => {
      const mockProducts = [
        ...
        {
          id: `prod_${Date.now() + 1}_${Math.random().toString(36).substr(2, 9)}`,
      ...
      // Calcular precios automáticamente y agregar directamente al inventario
        ...
        <div className="p-6">
          <div className="flex justify-center gap-2 mb-4 border-b border-[var(--color-border)] pb-4">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold ${sourceType === 'upload' ? 'bg-[var(--color-primary)] text-[var(--color-primary-text)]' : 'bg-[var(--color-bg)]'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold ${sourceType === 'camera' ? 'bg-[var(--color-primary)] text-[var(--color-primary-text)]' : 'bg-[var(--color-bg)]'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold ${sourceType === 'url' ? 'bg-[var(--color-primary)] text-[var(--color-primary-text)]' : 'bg-[var(--color-bg)]'
                }`}
            >
            ...
            {sourceType === 'upload' && !imageSrc && (
              ...
              >
                ...
                <div className="text-xs text-blue-600 dark:text-blue-400 mt-2 max-w-xs">
                  📁 Sube imágenes de cualquier tamaño y formato para análisis de IA (sin límite de tamaño)
                </div>
              </button>
            )}
          ...
          <div className="mt-6 flex justify-end">
            ...
            >
              {isLoading ? (
                ...
                'Analizar y Agregar al Inventario'
              )}
            </button>
          </div>
        </div>
